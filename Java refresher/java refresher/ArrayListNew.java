...
public class ArrayListNew {
	...
	{ 
		...
		User u= new User("xyzs",24);
		User u1= new User("Abcd",22);
		User u3= new User("qwerty",25);
	   ...
	   ArrayList <User> uListNew= new ArrayList<User>();
	    ...
	    User u21= new User("xyzs New",21);
		User u22= new User("Abcd New",22);
		User u23= new User("qwerty New",25);
		uListNew.add(u21);
		uListNew.add(u22);
		uListNew.add(u23);
